...
Sistemare la scheda degli item dando il contesto. Per esempio una pokéball non deve poter curare gli status come il veleno o la paralisi, ma si devono impostare le configurazioni adatte alla pokéball, quindi la potenza di sigillo.
